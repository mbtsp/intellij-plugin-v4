 ...
 */
public interface HTMLTableElement extends w3c.dom.html.HTMLElement {
  /**
   * Returns the table's <code>CAPTION</code>, or void if none exists. 
   */
  public w3c.dom.html.HTMLTableCaptionElement getCaption();
  public void               setCaption(HTMLTableCaptionElement caption);
  /**
   * Returns the table's <code>THEAD</code>, or <code>null</code> if none 
   * exists. 
   */
  public w3c.dom.html.HTMLTableSectionElement getTHead();
  public void               setTHead(w3c.dom.html.HTMLTableSectionElement tHead);
  /**
   * Returns the table's <code>TFOOT</code>, or <code>null</code> if none 
   * exists. 
   */
  public w3c.dom.html.HTMLTableSectionElement getTFoot();
  public void               setTFoot(HTMLTableSectionElement tFoot);
  /**
   * Returns a collection of all the rows in the table, including all in 
   * <code>THEAD</code>, <code>TFOOT</code>, all <code>TBODY</code> elements. 
   */
  public w3c.dom.html.HTMLCollection getRows();
  /**
   ...
   */
  public w3c.dom.html.HTMLElement createTHead();
  /**
   ...
   */
  public w3c.dom.html.HTMLElement createTFoot();
  /**
   ...
   */
  public w3c.dom.html.HTMLElement createCaption();
  /**
