 ...
 * implement {@link w3c.dom.Element} must also implement the
...
public interface ElementTraversal {
     ...
     */
    w3c.dom.Element getFirstElementChild();

    /**
     * Returns the last child element node of this element. <code>null</code>
     * if this element has no child elements.
     */
    w3c.dom.Element getLastElementChild();
     ...
     */
    w3c.dom.Element getPreviousElementSibling();
