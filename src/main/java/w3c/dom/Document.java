 ...
 */
public interface Document extends w3c.dom.Node {
    /**
     ...
     */
    public w3c.dom.Element getDocumentElement();
     ...
     */
    public w3c.dom.Element createElement(String tagName)
     ...
     *   <code>Elements</code>.
     */
    public w3c.dom.NodeList getElementsByTagName(String tagname);
     ...
     * @since DOM Level 2
     */
    public w3c.dom.Node importNode(w3c.dom.Node importedNode,
                                   boolean deep)
                           throws w3c.dom.DOMException;
     ...
     * @since DOM Level 2
     */
    public w3c.dom.Element createElementNS(String namespaceURI,
     ...
     * @since DOM Level 3
     */
    public w3c.dom.Node adoptNode(w3c.dom.Node source)
                          throws w3c.dom.DOMException;
     ...
     * @since DOM Level 3
     */
    public w3c.dom.Node renameNode(Node n,
                                   String namespaceURI,
                                   String qualifiedName)
                           throws DOMException;
