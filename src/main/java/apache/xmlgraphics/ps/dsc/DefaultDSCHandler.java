...
public class DefaultDSCHandler implements DSCHandler {
    ...
    /** @see apache.xmlgraphics.ps.dsc.DSCHandler#startDocument(java.lang.String) */
    public void startDocument(String header) throws IOException {
        gen.writeln(header);
    }

    /** @see apache.xmlgraphics.ps.dsc.DSCHandler#endDocument() */
    public void endDocument() throws IOException {
        gen.writeDSCComment(DSCConstants.EOF);
    }

    /**
     * @see apache.xmlgraphics.ps.dsc.DSCHandler#handleDSCComment(
     *      apache.xmlgraphics.ps.dsc.events.DSCComment)
     */
    ...
    /** @see apache.xmlgraphics.ps.dsc.DSCHandler#line(java.lang.String) */
    public void line(String line) throws IOException {
        gen.writeln(line);
    }

    /** @see apache.xmlgraphics.ps.dsc.DSCHandler#comment(java.lang.String) */
