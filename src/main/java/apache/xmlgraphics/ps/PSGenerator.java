...
import apache.xmlgraphics.java2d.color.ColorUtil;
import apache.xmlgraphics.java2d.color.ColorWithAlternatives;
import apache.xmlgraphics.ps.dsc.ResourceTracker;
import apache.xmlgraphics.util.DoubleFormatUtil;
...
public class PSGenerator implements PSCommandMap {
     ...
     * @exception IOException In case of an I/O problem
     * @see apache.xmlgraphics.ps.DSCConstants
     */
