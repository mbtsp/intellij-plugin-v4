...
package apache.xmlgraphics.image.writer;
...
public abstract class AbstractImageWriter implements ImageWriter {
    ...
    /**
     * @see apache.xmlgraphics.image.writer.ImageWriter#createMultiImageWriter(
    ...
    /** @see apache.xmlgraphics.image.writer.ImageWriter#isFunctional() */
    public boolean isFunctional() {
        return true;
    }

    /** @see apache.xmlgraphics.image.writer.ImageWriter#supportsMultiImageWriter() */
