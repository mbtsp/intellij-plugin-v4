...
import apache.batik.css.engine.value.ShorthandManager;
import apache.batik.css.engine.value.ValueConstants;
import apache.batik.css.engine.value.ValueManager;
import apache.batik.css.engine.value.css2.ClipManager;
import apache.batik.css.engine.value.css2.CursorManager;
import apache.batik.css.engine.value.css2.DirectionManager;
import apache.batik.css.engine.value.css2.DisplayManager;
import apache.batik.css.engine.value.css2.FontFamilyManager;
import apache.batik.css.engine.value.css2.FontShorthandManager;
import apache.batik.css.engine.value.css2.FontSizeAdjustManager;
import apache.batik.css.engine.value.css2.FontSizeManager;
import apache.batik.css.engine.value.css2.FontStretchManager;
import apache.batik.css.engine.value.css2.FontStyleManager;
import apache.batik.css.engine.value.css2.FontVariantManager;
import apache.batik.css.engine.value.css2.FontWeightManager;
import apache.batik.css.engine.value.css2.OverflowManager;
import apache.batik.css.engine.value.css2.SrcManager;
import apache.batik.css.engine.value.css2.TextDecorationManager;
import apache.batik.css.engine.value.css2.UnicodeBidiManager;
import apache.batik.css.engine.value.css2.VisibilityManager;
import apache.batik.css.engine.value.svg.AlignmentBaselineManager;
import apache.batik.css.engine.value.svg.BaselineShiftManager;
import apache.batik.css.engine.value.svg.ClipPathManager;
import apache.batik.css.engine.value.svg.ClipRuleManager;
import apache.batik.css.engine.value.svg.ColorInterpolationFiltersManager;
import apache.batik.css.engine.value.svg.ColorInterpolationManager;
import apache.batik.css.engine.value.svg.ColorManager;
import apache.batik.css.engine.value.svg.ColorProfileManager;
import apache.batik.css.engine.value.svg.ColorRenderingManager;
import apache.batik.css.engine.value.svg.DominantBaselineManager;
import apache.batik.css.engine.value.svg.EnableBackgroundManager;
import apache.batik.css.engine.value.svg.FillRuleManager;
import apache.batik.css.engine.value.svg.FilterManager;
import apache.batik.css.engine.value.svg.GlyphOrientationHorizontalManager;
import apache.batik.css.engine.value.svg.GlyphOrientationVerticalManager;
import apache.batik.css.engine.value.svg.ImageRenderingManager;
import apache.batik.css.engine.value.svg.KerningManager;
import apache.batik.css.engine.value.svg.MarkerManager;
import apache.batik.css.engine.value.svg.MarkerShorthandManager;
import apache.batik.css.engine.value.svg.MaskManager;
import apache.batik.css.engine.value.svg.OpacityManager;
import apache.batik.css.engine.value.svg.PointerEventsManager;
import apache.batik.css.engine.value.svg.SVGColorManager;
import apache.batik.css.engine.value.svg.SVGPaintManager;
import apache.batik.css.engine.value.svg.ShapeRenderingManager;
import apache.batik.css.engine.value.svg.SpacingManager;
import apache.batik.css.engine.value.svg.StrokeDasharrayManager;
import apache.batik.css.engine.value.svg.StrokeDashoffsetManager;
import apache.batik.css.engine.value.svg.StrokeLinecapManager;
import apache.batik.css.engine.value.svg.StrokeLinejoinManager;
import apache.batik.css.engine.value.svg.StrokeMiterlimitManager;
import apache.batik.css.engine.value.svg.StrokeWidthManager;
import apache.batik.css.engine.value.svg.TextAnchorManager;
import apache.batik.css.engine.value.svg.TextRenderingManager;
import apache.batik.css.engine.value.svg.WritingModeManager;
import apache.batik.css.parser.ExtendedParser;
