 ...
 * are needed by the {@link apache.batik.svggen.SVGGraphics2D} to
 * generate SVG from Java 2D primitives.
 * You can subclass it to change the defaults.
 *
 * @see apache.batik.svggen.SVGGraphics2D#SVGGraphics2D(SVGGeneratorContext,boolean)
...
public class SVGGeneratorContext implements ErrorConstants {
     ...
     * @see apache.batik.svggen.ImageHandler
     * @see apache.batik.svggen.ImageHandlerBase64Encoder
     * @see apache.batik.svggen.ImageHandlerPNGEncoder
     * @see apache.batik.svggen.ImageHandlerJPEGEncoder
     */
     ...
     * other information.
     * @see apache.batik.svggen.SVGIDGenerator
     * @see apache.batik.svggen.DefaultExtensionHandler
     * @see apache.batik.svggen.ImageHandlerBase64Encoder
     * @see apache.batik.svggen.DefaultStyleHandler
     * @see apache.batik.svggen.DefaultErrorHandler
     */
    ...
    /**
     * Returns the {@link apache.batik.svggen.SVGIDGenerator} that
     * has been set.
     */
    ...
    /**
     * Sets the {@link apache.batik.svggen.SVGIDGenerator}
    ...
    /**
     * Returns the {@link apache.batik.svggen.ExtensionHandler} that
     * has been set.
     */
    ...
    /**
     * Sets the {@link apache.batik.svggen.ExtensionHandler}
     * to be used. It should not be <code>null</code>.
     */
    ...
    /**
     * Returns the {@link apache.batik.svggen.ImageHandler} that
     * has been set.
     */
    ...
    /**
     * Sets the {@link apache.batik.svggen.ImageHandler}
     * to be used. It should not be <code>null</code>.
     */
    ...
    /**
     * Sets the {@link apache.batik.svggen.GenericImageHandler}
     * to be used.
     */
    ...
    /**
     * Returns the {@link apache.batik.svggen.StyleHandler} that
     * has been set.
     */
    ...
    /**
     * Sets the {@link apache.batik.svggen.StyleHandler}
     * to be used. It should not be <code>null</code>.
     */
    ...
    /**
     * Returns the {@link apache.batik.svggen.ErrorHandler} that
     * has been set.
     */
    ...
    /**
     * Sets the {@link apache.batik.svggen.ErrorHandler}
     * to be used. It should not be <code>null</code>.
     */
