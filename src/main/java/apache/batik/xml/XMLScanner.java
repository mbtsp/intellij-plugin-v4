...
import apache.batik.util.io.NormalizingReader;
import apache.batik.util.io.StreamNormalizingReader;
import apache.batik.util.io.StringNormalizingReader;
...
public class XMLScanner implements Localizable {
    ...
    protected static final String BUNDLE_CLASSNAME =
        "apache.batik.xml.resources.Messages";
