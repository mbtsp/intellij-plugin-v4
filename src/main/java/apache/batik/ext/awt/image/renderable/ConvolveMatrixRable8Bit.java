...
import apache.batik.ext.awt.image.GraphicsUtil;
import apache.batik.ext.awt.image.PadMode;
...
import apache.batik.ext.awt.image.rendered.PadRed;
...
public class ConvolveMatrixRable8Bit
    ...
    public RenderedImage createRendering(RenderContext rc) {
        ...
        // apache.batik.test.gvt.ImageDisplay.printImage
        //     ("Padded Image", ri,
        ...
        if (!preserveAlpha) {
            ...
            // apache.batik.test.gvt.ImageDisplay.showImage
            //   ("tmpSrcBI: ", tmpSrcBI);
